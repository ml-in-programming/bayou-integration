...
import tanvd.bayou.implementation.core.synthesizer.implementation.EvidenceExtractor
import tanvd.bayou.implementation.core.synthesizer.implementation.ParseException
import tanvd.bayou.implementation.core.synthesizer.implementation.Parser
import tanvd.bayou.implementation.core.synthesizer.implementation.Synthesizer
...
class ApiSynthesizerRemoteTensorFlowAsts(private val _tensorFlowHost: String?, private val _tensorFlowPort: Int,
    ...
    private fun synthesiseHelp(code: String?, maxProgramCount: Int, sampleCount: Int?): Iterable<String> {
         ...
         */
        var synthesizedPrograms: List<String>
        synthesizedPrograms = Synthesizer().execute(parser, astsJson)
