...
import tanvd.bayou.implementation.core.service.ApiSynthesisClient
import tanvd.bayou.implementation.core.service.ParseError
import tanvd.bayou.implementation.core.service.SynthesisError
...
internal object ApiSynthesisLocalClient {
...
//    }
    ...
    @Throws(IOException::class, SynthesisError::class, ParseException::class)
    @JvmStatic
