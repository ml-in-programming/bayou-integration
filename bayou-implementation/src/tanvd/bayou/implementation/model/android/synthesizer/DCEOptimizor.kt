...
class DCEOptimizor : ASTVisitor() {
    // The def variables
    protected var defs: MutableMap<String, MutableList<ASTNode>> = HashMap()

    // The use variables
    protected var uses: MutableMap<String, MutableList<ASTNode>> = HashMap()

    // The eliminated variable declarations
    var eliminatedVars: MutableSet<String> = HashSet()

    // Apply the optimization here
    fun apply(body: Block, dAST: DSubTree): Block {
